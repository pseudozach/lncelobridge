...
contract ERC20Swap {
    ...
    /// Locks tokens for a swap in the contract and forwards a specified amount of CELO to the claim address
    /// @notice The amount of CELO forwarded to the claim address is the amount sent in the transaction and the refund address is the sender of the transaction
    ...
    function lockPrepayMinerfee(
        ...
        // Forward the amount of CELO sent in the transaction to the claim address
    ...
    function claim(
        ...
        // Reentrancy is a bigger problem when sending CELO but there is no real downside to deleting from the mapping first
        delete swaps[hash];
