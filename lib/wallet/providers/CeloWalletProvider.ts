...
import { getGasPrice } from '../celo/EthereumUtils';
import WalletProviderInterface, { SentTransaction, WalletBalance } from './WalletProviderInterface';

class CeloWalletProvider implements WalletProviderInterface {
  ...
  constructor(private logger: Logger, private signer: Signer) {
    this.symbol = 'CELO';
    this.logger.info('Initialized Celo wallet');
  }
...
export default CeloWalletProvider;
